...
class InterviewProcessor:
    ...
    def analyze_transcription(self, transcription):
        ...
        Language: you should be able to understand English and Spanish. The output should be written in English or Spanish depending on the language of the interview. 
